                        ...
                        <form method="POST" action="{{ route('admin.manage-companies.store') }}" class="needs-validation"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input name="company_email" type="email" class="form-control" id="validationCustom01"
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input name="company_phone" type="number" class="form-control" id="validationCustom01"
